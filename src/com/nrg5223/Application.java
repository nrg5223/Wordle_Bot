 ...
 *                    details are recorded in a text file.
 *                  - this run configuration is meant for developer use
 *                  - additional arguments:
 *                        args[1] - the solver version
        ...
        try {
            ...
            try {
                switch (runType) {
                    ...
                    case "test" -> {
                        (new AllStatsGetter(solverVersion, strWordleLib, strSolutionLib)).runTests();
                        Print.done();
                    }
                    ...
                    case "test_all" -> {
                        for (int i = 1; i <= Solvers.numberOfVersions; i++) {
                            ...
                            (new AllStatsGetter(i, strWordleLib, strSolutionLib)).runTests();
                            Print.done();
                        }
                    }
